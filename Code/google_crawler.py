...
class google_crawler():
    ...
    def __init__(self,keyword_input,save_path):
    ...
    def get_the_content_for_a_single_page(self, url):
    ...
    def multiple_pages_crawling(self):
        ...
        for page_index in page_indices:
            ...
            if str(self.get_the_content_for_a_single_page(page_url)).isdigit():
                    count_news_per_page = self.get_the_content_for_a_single_page(page_url)
                    collected_news = collected_news + count_news_per_page
                    print "collected news equals to " + str(collected_news) + "!"
            else:
                print self.get_the_content_for_a_single_page(page_url)
                break
...
google_crawler('shopify', '/Users/yibingyang/Documents/new_folder_for_thesis/').main()

# google_crawler('legalization day canada', '/Users/yibingyang/Documents/new_folder_for_thesis/').main()
# google_crawler('cannabis canada', '/Users/yibingyang/Documents/new_folder_for_thesis/').main()